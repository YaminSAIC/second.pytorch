...
"""
# kitti clean is for filter out difficulty ground truth which is wrongly noted.
...
def _prepare_data(gt_annos, dt_annos, current_class, difficulty):
    ...
    for i in range(len(gt_annos)):
        ...
        '''
        print("dtbbox: ", dt_annos[i]["bbox"])
        print("dtalpha: ", dt_annos[i]["alpha"])
        print(type(dt_annos[i]["bbox"]), type(dt_annos[i]["alpha"]))
        print(dt_annos[i]["bbox"].shape, dt_annos[i]["alpha"].shape)
        print("gtbbox: ", gt_annos[i]["bbox"])
        print("gtalpha: ", gt_annos[i]["alpha"])
        print(type(gt_annos[i]["bbox"]), type(gt_annos[i]["bbox"]), )
        print(gt_annos[i]["bbox"].shape, gt_annos[i]["alpha"].shape)
        '''
...
def get_official_eval_result(gt_annos, dt_annos, current_classes, difficultys=[0, 1, 2], return_data=False):
    ...
    # current_classes = [i % 8 for i in current_classes_int]
